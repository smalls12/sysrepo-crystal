...
class Callback
  ...
  getter rpc_cb : Proc( Session, String | Nil, Libsysrepo::SysrepoValue*, UInt32, Libsysrepo::SysrepoEvent, UInt32, Libsysrepo::SysrepoValue**, UInt32, Void*, Int32) | Nil
